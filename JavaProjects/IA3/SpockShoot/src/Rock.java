...
public class Rock extends Choice{
    ...
    public String getName() {
        return GameChoices.ROCK.toString();
    }
    ...
    public String competeExplanation(Choice otherPlayerChoice) {
        ...
        if (otherPlayerChoice instanceof Scissors) return "Rock breaks Scissors";
        if (otherPlayerChoice instanceof Lizard) return "Rock crushes Lizard";
        if (otherPlayerChoice instanceof Paper) return "Paper covers Rock";
        if (otherPlayerChoice instanceof Spock) return "Spock vaporizes Rock";
    ...
    public int determineWin(Choice otherPlayerChoice) {
        if (otherPlayerChoice instanceof Scissors || otherPlayerChoice instanceof Lizard) {
            return 1; // rock wins
        } else if (otherPlayerChoice instanceof Rock) {
